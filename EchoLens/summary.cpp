...
//}
//
//static bool isRelevantToTarget(const string& text, const string& targetName) {
...
//    return containsMultipleNameParts(text, targetName);
//}
//
//// ------------------ Enhanced Context Window with Name Prioritization ------------------
//static string extractTargetContext(const string& content, const string& name) {
...
//        if (isRelevantToTarget(para, name)) {
//            focusedContent += para + " ";
//        }
//    }
//
...
//        if (!isRelevantToTarget(line, name)) {
//            continue;
//        }
//
...
//        if (isRelevantToTarget(fact.value, name)) {
...
//            if (!name.empty()) {
//                content = extractTargetContext(content, name);
...
//                    }
//                    else {
//                        // STRICTER: Reduce proximity window and require name presence
//                        accept = isNearby(content, pos, name, 100); // Reduced from 150 to 100
//                        // Additional check: ensure name appears in the same context
//                        if (accept) {
...
//                            accept = isRelevantToTarget(contactContext, name);
//                        }
//                    }
//                }
//                if (!accept) continue;
...
//        filterIrrelevantFacts(knowledgeBase, name);
//
