...
//// Measures token overlap instead of heavy Levenshtein (fast for MSVC)
...
//}
//
//// === NARRATIVE SUMMARY PARAGRAPH GENERATOR ===
...
//
//    string designation, department, education, research, timeline;
//    vector<string> misc;
//
//    for (const auto& f : facts) {
//        string cat = toLowerTrim(f.category);
//        string val = f.value;
//
...
//            education = val;
//        else if (cat.find("research") != string::npos || cat.find("specialization") != string::npos)
//            research = research.empty() ? val : (research + ", " + val);
//        else if (cat.find("timeline") != string::npos)
//            timeline = val;
//        else
//            misc.push_back(val);
//    }
...
//        ss << " is " << ((designation.find("at") != string::npos) ? "" : "an ") << designation;
//        if (!department.empty())
//            ss << " in " << department;
//        ss << ". ";
//    }
...
//
//    if (!research.empty())
//        ss << "Their expertise includes " << research << ". ";
//
//    if (!timeline.empty())
//        ss << "Career timeline indicates " << timeline << ". ";
//
//    if (!misc.empty()) {
//        ss << "Additional notes: ";
...
//}
//
//// === UPDATED PRINT SUMMARY (KEEPING OLD FACTS + ADDING NEW FUSED VIEW) ===
...
//    for (auto& uf : fused) {
//        cout << "[" << uf.category << "] " << uf.value
//            << "  (Sources: " << uf.sources.size() << ")\n";
//        for (auto& s : uf.sources)
//            cout << "     ↳ " << s << "\n";
//    }
//
//    // --- NARRATIVE SUMMARY ---
...
//    cout << "====================\n";
//    cout << generateSummaryParagraph(fused, name) << "\n";
//}
//
//
//// ------------------ MAIN ------------------
...
//        printSummaryWithFusion(allExtractedFacts, name);
//
//        // CHANGES MADE HERE 
//       /* cout << "\n==============================\n";
